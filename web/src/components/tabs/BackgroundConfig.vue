<template>
  <div class="space-y-6">
    <div>
      <h3 class="text-lg font-medium text-gray-900 mb-2">Cấu hình nền trò chuyện</h3>
      <p class="text-gray-600">Cấu hình nền cho chế độ sáng và chế độ tối, hỗ trợ màu trơn hoặc ảnh tùy chỉnh.</p>
    </div>

  <!-- Cấu hình chế độ sáng -->
    <div class="space-y-4">
  ...
  <!-- Chọn màu cho chế độ sáng -->
        <div v-if="modelValue.light.backgroundType === 'color'" class="space-y-3">
          <div class="flex items-center space-x-3">
            <label class="text-sm font-medium text-gray-700">Màu nền:</label>
          ...
          <div class="flex items-center space-x-3">
            <label class="text-sm font-medium text-gray-700">Màu chữ:</label>
            <div class="flex items-center space-x-2">
              <input
                type="color"
  ...
  <!-- Tải ảnh nền cho chế độ sáng -->
        <div v-if="modelValue.light.backgroundType === 'image'" class="space-y-3">
          <label class="text-sm font-medium text-gray-700">Ảnh nền:</label>
          <div 
          ...
          >
            ...
            <div v-if="!modelValue.light.backgroundImage" @click="$refs.lightImageInput.click()">
              ...
              <p class="mt-1 text-sm text-gray-600">Nhấp hoặc kéo thả để tải ảnh nền</p>
            </div>
          ...
          <!-- Màu chữ cho ảnh nền (chế độ sáng) -->
          <div class="flex items-center space-x-3">
  ...
  <!-- Tải ảnh nền cho chế độ tối -->
        <div v-if="modelValue.dark.backgroundType === 'image'" class="space-y-3">
          ...
          <!-- Màu chữ cho ảnh nền (chế độ tối) -->
          <div class="flex items-center space-x-3">
            <label class="text-sm font-medium text-gray-700">Màu chữ:</label>
            <div class="flex items-center space-x-2">
              <input
  ...
  <!-- Khu vực xem trước -->
    <div class="space-y-4">
  <h4 class="font-medium text-gray-900">Khu vực xem trước</h4>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- 浅色模式预览 -->
        <div class="space-y-2">
          <div class="text-sm font-medium text-gray-700">Chế độ sáng</div>
          <div 
        ...
        <!-- 深色模式预览 -->
        <div class="space-y-2">
          <div class="text-sm font-medium text-gray-700">Chế độ tối</div>
          <div 
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
      <h5 class="font-medium text-blue-900 mb-2">Cấu hình nhanh</h5>
